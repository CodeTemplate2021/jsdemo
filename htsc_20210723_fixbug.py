...
HT_cookies_list = [
    'us=direct; um=direct; uc=direct; ut=direct; utm_source=direct; utm_medium=direct; utm_campaign=direct; utm_term=direct; memberinfo={"id":"751321873","name":"用户01661397310","oid":"ZEcxcm5YbC83ZStYcC9ibVZpdjNpdz09"}; sa_distinct_id=ZEcxcm5YbC83ZStYcC9ibVZpdjNpdz09; sensorsdata2015jssdkcross={"distinct_id":"ZEcxcm5YbC83ZStYcC9ibVZpdjNpdz09","$device_id":"17abc91beb5389-03ed801a34cee1-6373264-2304000-17abc91beb6b54","props":{"$latest_referrer":"","$latest_traffic_source_type":"直接流量","$latest_search_keyword":"未取到值_直接打开"},"first_id":"17abc91beb5389-03ed801a34cee1-6373264-2304000-17abc91beb6b54"}; cookies-tips=should_close; oppostore_rsa_key=MFwwDQYJKoZIhvcNAQEBBQADSwAwSAJBAJCYMLNhFBtDcbb72YZVDm/FG3m3oR4kU8f7JgvAmhI/lQvqhYczoJz8QZU30ml0nvtO2dB/fcqTEW9RyUhw8jUCAwEAAQ==; newopkey=zPs6-nNwJwfpG7397fpNPr3RkASBNF-d0w5nZvNOL6IP6i9Q9SJMrhX_6aTnTjj0Gc1gCUQl_u8; opkey=; sessionId=zPs6-nNwJwfpG7397fpNPr3RkASBNF-d0w5nZvNOL6IP6i9Q9SJMrhX_6aTnTjj0Gc1gCUQl_u8; NEWOPPOSID=; HEYTAPID=zPs6-nNwJwfpG7397fpNPr3RkASBNF-d0w5nZvNOL6IP6i9Q9SJMrhX_6aTnTjj0Gc1gCUQl_u8; username=用户01661397310; avatar=https://uc-avatar-cn.heytapimage.com/titans-usercenter-avatar-bucket-cn/default-new.png',
]
## 填入抓取到User-Agent，参考以下 【建议使用自己抓取的！避免异常/防黑(推测）】
HT_UserAgent_list = [
    'Mozilla/5.0 (Linux; U; Android 9; zh-cn; X9007 Build/KTU84P) AppleWebKit/537.36 (KHTML, like Gecko)Version/4.0 Chrome/81.0.4044.117 Mobile Safari/537.36 oppostore/200802',
]
## 填入推送方式及对应值
notice_list = [
